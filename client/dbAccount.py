# This file is used to record the username and password of the SQL database on YOUR OWN COMPUTER.
# You should revise this file after you pull the project files from github
